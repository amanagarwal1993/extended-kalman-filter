...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
        ...
        MatrixXd Hj;
        Tools tools;
        Hj = tools.CalculateJacobian(x);
        cout << Hj << " Hj \n"<<endl;

        ekf_.x_ = Hj.inverse() * x;

        cout<<ekf_.x_<<" After adding radar values to it"<<endl;
    }
      ...
      */
        ...
        cout<<ekf_.x_<<" After adding laser values to it"<<endl;   
    }
    ...
    return;
        ...
        cout<<"First Iteration after initialization"<<endl;
